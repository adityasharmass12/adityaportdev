...
![Portfolio Preview](public/my-image.jpg.jpeg) <!-- Update this path if you have a screenshot of the site -->
...
1. Clone the repository:
   ```bash
   git clone https://github.com/adityasharmass12/adityaportdev.git